...
public class SalesGST extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public class OfferAsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            try {
                ...
                parseResult(gr.GetResponses(Webservices.WEBSERVICE_BILL_SALE_GST));
