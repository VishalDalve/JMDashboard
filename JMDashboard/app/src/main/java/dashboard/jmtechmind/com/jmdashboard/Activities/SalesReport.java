...
public class SalesReport extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public class OfferAsyncHttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            try {
                ...
                parseResult(gr.GetResponses(Webservices.WEBSERVICE_SALES_REPORT));
